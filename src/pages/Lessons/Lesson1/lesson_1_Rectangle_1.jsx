    ...
    render() {
        return <div className="wrapper-lesson wrapper-lesson--geometry">
            <div className="wrapper__screen-left wrapper__screen-left--full6">
                <div className="canvas-block" id="math-lesson-1-square">
                    <img src="/img/mat_lesson_1/lesson_1_Square_10001.png" alt="" className="lesson-img-6"/>
                </div>

                <div className="canvas-block" style={{ backgroundImage: 'url(/img/mat_lesson_1/lesson_1_Rectangle_10001.png)' }}>
